...
func _init (p_kingdom_departure: KingdomDefinitionResource, p_kingdom_destination: KingdomDefinitionResource, p_owner_index: int, p_quantity: int, p_road_path_soldier: Array, p_road_path_missive: Array, p_step: int = -1) -> void:
